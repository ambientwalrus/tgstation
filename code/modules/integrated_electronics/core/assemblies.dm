...
/obj/item/electronic_assembly/proc/rename()
	...
	if(src && input)
		...
		src.investigate_log("was renamed '[input]' by [key_name(usr)].", INVESTIGATE_CIRCUIT)
		name = input
...
/obj/item/electronic_assembly/attackby(obj/item/I, mob/living/user)
	...
	if(istype(I, /obj/item/integrated_circuit))
		...
		src.investigate_log("had a battery inserted by [key_name(user)].", INVESTIGATE_CIRCUIT)
		interact(user)
		return TRUE
